...
* **Markdown** can be used for everything. People use it to create _**websites, documents, notes, books, presentations, email messages, and technical documentation**_.

* **Markdown** is portable. Files containing **Markdown**-formatted text can be _**opened using virtually any application**_. 
